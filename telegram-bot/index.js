...
bot.command("create", async (ctx) => {
  ctx.reply("Create a new token:", {
    reply_markup: {
      inline_keyboard: [
        [
          {
            text: "Create Token",
            web_app: { url: `${process.env.WEB_APP_URL}/create-token` },
          },
        ],
      ],
    },
...
bot.command("borrow", async (ctx) => {
  ctx.reply("Borrow liquidity:", {
    reply_markup: {
      inline_keyboard: [
        [
          {
            text: "Borrow Liquidity",
            web_app: { url: `${process.env.WEB_APP_URL}/borrow` },
          },
        ],
      ],
    },
